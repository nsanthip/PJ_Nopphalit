            ...
            <main class="p-3">
                <div class="container-fluid">
                    <div class="mb-3 text-center" style="border: 2px solid #007bff; border-radius: 10px; padding: 20px; background-color: #f8f9fa;">
                        <h1 class="text-primary" style="font-family: 'Arial', sans-serif;">อุปกรณ์ ยืม-คืน</h1>
                    </div>
                    ...
                    <div class="container-fluid col-sm-8">
                        <div class="container" style="max-width: auto; margin: 20px auto; font-family: Arial, sans-serif; background-color: #f9f9f9; border: 1px solid #ddd; border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px;">
                            <?php
                            $Borrow_data = $db_handle->Textquery(
                                "SELECT b.Record_id, e.Equipment_name, u.Name , b.Borrow_date, b.Return_date, b.Status
                                    ...
                                    <tbody>
                                        <?php foreach ($Borrow_data as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($Borrow_data[$key]["Equipment_name"]); ?></td>
                                                <td><?php echo htmlspecialchars($Borrow_data[$key]["Name"]); ?></td>
                                                <td><?php echo htmlspecialchars($Borrow_data[$key]["Borrow_date"]); ?></td>
                                                <td><?php echo htmlspecialchars($Borrow_data[$key]["Return_date"]); ?></td>
